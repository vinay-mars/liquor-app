          ...
          return GetBuilder<CartController>(
            builder: (cartController) {
              return GridView.builder(
                ...
                itemCount: productController.productData.where((product) => product["featured"] == true).length + (productController.isMoreDataAvailable ? 1 : 0),
                itemBuilder: (_, index) {
                  // Get the featured products
                  var featuredProducts = productController.productData.where((product) => product["featured"] == true).toList();
