            ...
            builder: (productController) {
              return RefreshIndicator(
                ...
                child: Scaffold(
                                                         ...
                                                         child: Row(
                                                           children: [
                                                             GestureDetector(
                                                                 ...
                                                                 child: const Icon(Icons.cancel,color: AppColors.appBlackColor,)),
                                                                ...
                                                                children: [
                                                                  Container(
                                                                    ...
                                                                    child: ListTile(
                                                                      ...
                                                                      title: Text("my_profile".tr,style: GoogleFonts.roboto(
                                                                          fontWeight: FontWeight.w500,
                                                                          fontSize: 14
                                                                      ),),
                                                                      leading: const Icon(Icons.person_2,color: AppColors.appPrimaryColor,),
                                                                      trailing: const Icon(Icons.arrow_forward_ios_sharp,color: Color(0xff959396),),
                                                                    ),
                                                                  ),
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child: ListTile(
                                                                      ...
                                                                      title: Text("my_order".tr,style: GoogleFonts.roboto(
                                                                          fontWeight: FontWeight.w500,
                                                                          fontSize: 14
                                                                      ),),
                                                                      leading: const Icon(Icons.sticky_note_2,color: AppColors.appPrimaryColor,),
                                                                      trailing: const Icon(Icons.arrow_forward_ios_sharp,color: Color(0xff959396)),
                                                                    ),
                                                                  ),
                                                                  const SizedBox(height: 8,),
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            Container(
                                                                              ...
                                                                              child: const Icon(Icons.language_outlined,color: AppColors.appPrimaryColor,),
                                                                            ),
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child: ListTile(
                                                                      ...
                                                                      title: Text("privacy_policy".tr,style: GoogleFonts.roboto(
                                                                          fontWeight: FontWeight.w500,
                                                                          fontSize: 14
                                                                      ),),
                                                                      leading: const Icon(Icons.privacy_tip_sharp,color: AppColors.appPrimaryColor,),
                                                                      trailing: const Icon(Icons.arrow_forward_ios_sharp,color: Color(0xff959396)),
                                                                    ),
                                                                  ),
                                                                  const SizedBox(height: 8,),
                                                                  Container(
                                                                    ...
                                                                    child: ListTile(
                                                                      ...
                                                                      title: Text("about_us".tr,style: GoogleFonts.roboto(
                                                                          fontWeight: FontWeight.w500,
                                                                          fontSize: 14
                                                                      ),),
                                                                                ...
                                                                                return AlertDialog(
                                                                                  ...
                                                                                  actions: <Widget>[
                                                                                    TextButton(
                                                                                      ...
                                                                                      child: Text('cancel'.tr,style: GoogleFonts.roboto(
                                                                                          color: Colors.red
                                                                                      ),),
                                                                                    ),
                                                                                    TextButton(
                                ...
                                const Expanded(flex: 6, child: SizedBox()),
                                 GestureDetector(
                                   ...
                                   child: Stack(
                                    ...
                                    children: [
                                      const Icon(Icons.cached,color: AppColors.appWhiteColor,size: 26,),
                                      Positioned(
                                          top: -10,
                                          left: 0,
                                          right: -8,
                                          child: CircleAvatar(
                                              ...
                                              radius: 11,
                                              child: Text("${cartController.compareItems.length}",
                            ...
                            Expanded(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  enabledBorder: const OutlineInputBorder(borderSide: BorderSide(color: AppColors.appBlackColor)),
                                  focusedBorder: const OutlineInputBorder(borderSide: BorderSide(color: AppColors.appBlackColor)),
                                  ...
                                  prefixIcon: Padding(
                                    padding: const EdgeInsets.symmetric(
                                        vertical: 14,
                                        horizontal: 8), // Adjusted vertical padding
                                    child: Image.asset(
                                  ...
                                  contentPadding: const EdgeInsets.symmetric(
                                      vertical: 8,
                                      horizontal: 12), // Reduced content padding
                                ),
                              ),
                            ),
                                    ...
                                    Get.bottomSheet(
                                       Material(
                                          ...
                                          Container(
                                              ...
                                              child:
                                              productCategoryController.isLoading==false && productCategoryController.productCategoryData!=null?
                                              StatefulBuilder(
                                                  ...
                                                  return Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text("category".tr,style: GoogleFonts.roboto(
                                                            fontSize: 16,
                                                            color: AppColors.appPrimaryColor,
                                                            fontWeight: FontWeight.w500
                                                        ),),
                                                                ...
                                                                child: DropdownButtonFormField<dynamic>(
                                                                  ...
                                                                  onChanged: (dynamic newValue) {
                                                                    setState(() {
                                                                      ...
                                                                      final selectedCategory = productCategoryController.productCategoryData
                                                                  ...
                                                                  items: productCategoryController.productCategoryData.map<DropdownMenuItem<String>>((category) {
                                                                    return DropdownMenuItem<String>(
                                                                      value: category["name"],
                                                                      child: Text(category["name"].toString().replaceAll("&amp;", ""),
                                                                        style: GoogleFonts.roboto(
                                                                            fontSize: 14
                                                                        ),
                                                                      ),
                                                                  ...
                                                                  decoration: const InputDecoration(
                                                                    ...
                                                                    contentPadding: EdgeInsets.zero, // Remove padding inside the dropdown
                                                                  ),
                                                                ),
                                                              ),
                                                            ),
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text("price_range".tr,style: GoogleFonts.roboto(
                                                            fontSize: 16,
                                                            color: AppColors.appPrimaryColor,
                                                            fontWeight: FontWeight.w500
                                                        ),),
                                                            ...
                                                            Expanded(
                                                              child: TextFormField(
                                                                ...
                                                                decoration: InputDecoration(
                                                                  ...
                                                                  contentPadding: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 12.0), // Adjust vertical padding
                                                                ),
                                                              ),
                                                            ),
                                                      ...
                                                      Row(children: [
                                                        ...
                                                        Expanded(child: Padding(
                                                          ...
                                                          child: MaterialButton(
                                                            ...
                                                            child: Text('apply'.tr,style: GoogleFonts.roboto(
                                                                color: AppColors.appWhiteColor,fontSize: 14,fontWeight:
                                                            FontWeight.w500
                                                            ),),
                                                          ),
                                                        ),),
                                      ...
                                      isScrollControlled: true, // Ensure that the bottom sheet can be scrolled
                                      ignoreSafeArea: false, // Depending on your design, you might need to adjust this
                  ...
                  body: productCategoryController.isLoading == false && productCategoryController.productCategoryData != null
                      ? SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final filteredCategories = productCategoryController.productCategoryData
                                        .where((category) => category["name"].toString() != "Uncategorized")
                                        .toList();
                                    ...
                                    final categoryName = category["name"]?.replaceAll("&amp;", "&") ?? "Unknown";
                                    log("Categoryyyyyyyyyyyyyyyyyyyyyyyyyy ${imageUrl}");
                                        ...
                                        child: GestureDetector(
                                          ...
                                          CircleAvatar(
                                            ...
                                            child: SvgPicture.network(imageUrl)) :
                                              category["image"] != null && imageUrl != false ?
                                              CircleAvatar(
                                                radius: 30,
                                                backgroundColor: AppColors.appCategoryBgColor,
                                                child: Image.network(
                              ...
                              Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 16),
                                child: Divider(color: AppColors.appProductBorderColor.withOpacity(0.85),),
                              ),
                              GetBuilder<CartController>(
                                builder: (cartController) {
                                  ...
                                  return GridView.builder(
                                    ...
                                    itemCount: productController.productData.length + (productController.isMoreDataAvailable ? 1 : 0),
                                    itemBuilder: (_, index) {
                                      if (index >= productController.productData.length) {
                                        return const Center(
                                          child: SizedBox(
                                            height: 20,
                                            width: 20,
                                            child: CircularProgressIndicator(), // <-- for infinite scroll loading

                                          ),
                                        );
                                      }

                                      var product = productController.productData[index];
                                      var item = CartItem(
                                                ...
                                                children: [
                                                  ...
                                                  Positioned(
                                                     ...
                                                     isInWishlist==false?
                                                      ...
                                                      ):Image.asset("assets/images/wishlist_already.png",height: 24,width: 24)),
                                                ],
                                              ),
                                            ),
                                          ),
